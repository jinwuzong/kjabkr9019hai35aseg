...
local goldState = {}
for i = 1, #rarities do
    local on = i <= 4 -- default ON for first four (including Epic), OFF for Legendary, Mythical and Eternal only
    baseState[i] = on
    goldState[i] = on
end
...
RunService.Heartbeat:Connect(function()
    ...
    if bossModel then
        ...
        info.Text = string.format("ðŸ‘‘ %s detected", targetName)
    ...
    elseif regularFish then
        ...
        local emoji = rarityEmoji[rarity] or "ðŸŽ£"
